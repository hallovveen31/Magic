...
#define L_VAL_SCPLL_CAL_MAX	0x22 /* = 2916 MHz with 27MHz source */
...
/* Clock registers. *//* Frequency switch modes. */
...
static struct clkctl_acpu_speed acpu_freq_tbl_slow[] = {
  ...
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  /* OC'd to the Xtreme by Andrew Rushing */
  ...
  { {1, 1}, 2376000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(20), 1300000, 0x03006000},
  { {1, 1}, 2538000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(20), 1300000, 0x03006000},
  { {1, 1}, 2700000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(20), 1300000, 0x03006000},
  { {1, 1}, 2916000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(20), 1300000, 0x03006000},
  { {0, 0}, 0 },
};
